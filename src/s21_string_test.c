...
START_TEST(s21_memcmp_test) {
  char test1[] = "Stop tryin to be god";
  char test2[] = "God skill to code";
  char test3[] = "\0";
...
//   ck_assert_str_eq(dest, "Apple Pie");
...
//   char test1[] = "Jhony Cage";
//   char test2[] = "Jhony Cage";
//   char test3[] = "Scorp";
//   char test4[] = "SubZero";
//   char test5[] = "   ";
//   char test6[] = "\0HH";
...
START_TEST(n_specifier1) {
  ...
  char str2[BUFF_SIZE];
  int ret = 0;
  char *format = "Hello, my sexy abobina %n";
